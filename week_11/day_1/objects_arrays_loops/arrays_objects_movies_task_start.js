...
for (var movie of movies){
  var uppercasedTitles = movie.title.toUpperCase();
  console.log('movies: ', uppercasedTitles);
}
...
for (var movie of movies){
  if (movie.title === 'Citizen Kane'){
    ...
    console.log('released on: ', releaseYear);
  } 
}
...
for (var i=0; i < movies.length; i++){
  ...
  console.log("title", currentMovie.title)
  console.log("Audience rating: ", currentMovie.ratings.audience);
}